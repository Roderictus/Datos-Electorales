---
title: "Votos Nulos y Ausentismo Electoral Secciones Estado de México 2012"
...
```
En el post anterior vimos los votos por el PRI en un mapa que si bien atractivo visualmente tenia el problema de que era prácticamente imposible apreciar los resultados en las zonas urbanas. En esta entrega separaré por municipios y lo presentaré, gracias a Plotly, de una forma que permita conocer el nombre del municipio y/o Distrito, o que de algún grado de interactividad con el mapa. 
...
ggsave(Titulo, device = "png" ,plot = last_plot())
list.files()
"C:/Proyectos R/Datos-Electorales/Mapas Nuevos/Secciones Municipales/15/ "
}
